...
Edit `src/main.jsx` to change the name, email, social links and copy. All supplied portfolio images are already placed under `public/images/` and grouped by collection.
